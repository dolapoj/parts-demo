        ...
        <div className="flex flex-col">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mt-4 flex justify-start flex-wrap gap-4 px-6 sm:px-24">
              ...
              <button
                className="btn bg-green-500 text-white px-3 py-0 border-none font-semibold text-sm sm:w-64 flex items-center justify-center"
                type="submit"
                disabled={isLoading}
              >
                {isLoading ? (
                ...
                {isLoading ? "LOADING..." : "SEARCH VEHICLE PARTS"}
              </button>
            </div>
          </form>
          <p className="italic text-white text-sm pt-6 px-6 sm:px-24">
