...
const useProductData = () => {
  ...
  useEffect(() => {
    const storedData = localStorage.getItem("searchByBestSeller");
    if (storedData) {
                        ...
                        <div className="flex justify-evenly leading-relaxed">
                          ...
                          <div className="bg-green-700 p-4 text-white rounded-xl">
                            ...
                            <button
                              ...
                              className="text-black text-sm px-4 py-2 font-semibold w-full rounded-md mt-2"
                              style={{
                                backgroundColor: isInCart(part?.product_sku)
                                  ? "gray"
                                  : "yellow",
                              }}
                            >
...
export default SearchBestSeller;
